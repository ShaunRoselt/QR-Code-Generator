#!/bin/bash
cd /home/runner/work/QR-Code-Generator/QR-Code-Generator/modules/qr-modes

# Create remaining QR mode modules with basic structure
for mode in email phone sms whatsapp wifi location event appstore social vcard; do
    TITLE=$(echo $mode | sed 's/.*/\u&/')
    cat > ${mode}.js << EOF
        ...
        return \`
            <div class="qr-mode-page">
                <div class="content-header">
                    ...
                    <p class="content-subtitle">Create ${TITLE} QR codes</p>
                </div>
