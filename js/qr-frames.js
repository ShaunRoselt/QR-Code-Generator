...
const QRFrames = {
    ...
    getFramePreviewSVG(frameType) {
        ...
        if (frameType === 'none') {
            ...
            return `
                <svg viewBox="0 0 50 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="2" y="2" width="46" height="56" rx="2" stroke="#000000" stroke-width="4" fill="transparent"></rect>
                    <rect x="6" y="6" width="38" height="38" rx="2" fill="#E6E7ED"></rect>
                    <svg width="28" height="28" viewBox="0 0 40 40" x="11" y="11">
                        ${qrSample}
                    </svg>
                    <path d="M2 47h46" stroke="#000000" stroke-width="3"></path>
                    <text x="25" y="53" text-anchor="middle" font-size="6" font-weight="700" fill="#000000">Scan me!</text>
                </svg>
            `;
        }
    ...
    drawScanMeBorderFrame(ctx, width, totalHeight, textHeight) {
        ...
        const borderWidth = 8;  // Increased from 4 to 8
    ...
    wrapSVGWithFrame(qrSVG, frameType, size) {
        ...
        if (frameType === 'scanme') {
            ...
            // Frame with border - matching provided SVG structure with thicker borders
            svg = `<svg viewBox="0 0 ${size} ${totalHeight}" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect id="frame" x="1" y="1" width="${size - 2}" height="${totalHeight - 2}" rx="3" stroke="#000000" stroke-width="8" fill="transparent"></rect>
                <g id="frame">
                ...
                <path d="M1 ${qrSize}h${size - 2}" stroke="#000000" stroke-width="3"></path>
                <g id="text-container">
                    <text x="${size / 2}" y="${qrSize + (textHeight / 2) + 5}" text-anchor="middle" dominant-baseline="middle" font-size="${Math.floor(textHeight * 0.5)}" font-weight="700" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" fill="#000000">Scan me!</text>
                </g>
            </svg>`;
