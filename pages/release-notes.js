...
const ReleaseNotesPage = {
            ...
            <div class="qr-mode-page">
                ...
                <div class="release-notes-container" id="releaseNotesContent">
                    <div class="loading-spinner">
                        ...
                        <p>${I18n.translateString('Loading release notes...')}</p>
                    </div>
                </div>
            </div>
        `;
    ...
    async init() {
        try {
            ...
            if (!response.ok) {
                throw new Error(I18n.translateString('Failed to load release notes. Please try again later.'));
            }
            ...
            document.getElementById('releaseNotesContent').innerHTML = `
                <div class="error-message">
                    ...
                    <p>${I18n.translateString('Failed to load release notes. Please try again later.')}</p>
                </div>
            `;
        }
    },
